...
class FishingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fishing" do
    assert_difference('Fishing.count') do
      post fishings_url, params: { fishing: { author_id: @fishing.author_id, imagen: @fishing.imagen, text: @fishing.text, title: @fishing.title } }
    end
  ...
  test "should update fishing" do
    patch fishing_url(@fishing), params: { fishing: { author_id: @fishing.author_id, imagen: @fishing.imagen, text: @fishing.text, title: @fishing.title } }
